...
public class SuccessWalletActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtBack.setText(getResources().getString(R.string.continue_shopping));
        imgTopImage.setImageDrawable(getResources().getDrawable(R.drawable.ic_walletsuccess));
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(SuccessWalletActivity.this, MainActivity.class);
      //  intent.putExtra("IntentType", "WalletSuccess");
