...
import com.getprofitam.android.adapter.OfferZoneAdapter;
import com.getprofitam.android.model.OfferModel;
...
public class OffersActivity extends AppCompatActivity {
    ...
    class DownloadSelctedIMG extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... arg0) {
            ...
            String filename = "GetProfitam.jpg";
            File wallpaperDirectory = new File(Environment.getExternalStorageDirectory().toString() + "/GetProfitam_new/Event/"
            );
...
//							  				);
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                intent.putExtra(android.content.Intent.EXTRA_SUBJECT, "GetProfitam");
