...
public class SuccessorderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getprofitamDB = new GetprofitamDB(SuccessorderActivity.this, FinalLocalDBName);
        ...
        imgTopImage.setImageDrawable(getResources().getDrawable(R.drawable.ic_successorder));
        if (ordertype.equalsIgnoreCase("PAYTM")) {
            ...
            tvExpression.setText(msg1);
            txtohh.setText(msg2);
        } else if (ordertype.equalsIgnoreCase("COD")) {
            tvExpression.setText(msg1);
            txtohh.setText(msg2);
        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(SuccessorderActivity.this, OrderHistoryActivity.class);
