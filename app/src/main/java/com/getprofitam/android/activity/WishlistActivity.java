...
import com.getprofitam.android.adapter.WishlistAdapter;
...
public class WishlistActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getprofitamDB = new GetprofitamDB(WishlistActivity.this, FinalLocalDBName);
        getprofitamDB.OpenDB();
        cursorCart = getprofitamDB.ShowTableCartList();
        cursorWishlist = getprofitamDB.ShowTableWishList();
        ...
        productListNewAdapter.setOnItemClickListener(new WishlistAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View view, int i) {
                if (i == 1) {
                    ...
                    getprofitamDB.DeleteWishlistItems(listOfProduct.get(position).getProductID());
    ...
    private String generateJson() {
        ...
        try {
            ...
            ArrayList<String> listWish = getprofitamDB.getAllProduct();
