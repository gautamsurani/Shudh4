...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> {
    ...
    public CartAdapter(Activity activity, ArrayList<CartData> bean) {
        ...
        mprefs = main.getSharedPreferences(AppConstant.PREFS_NAME, main.MODE_PRIVATE);
    ...
    public void onBindViewHolder(final CartAdapter.ViewHolder holder, final int position) {
        ...
        try {
            holder.tvCartPrice.setText(main.getResources().getString(R.string.Rs) + " " + ThiQuantity * Integer.parseInt(StrNewPtice) + "");
            ...
            public void onClick(View view) {
                if (mOnItemClickListener != null) {
                    ...
                    if (bean.getCountThis() == 1) {
                        ...
                        int total = counter - 1;
                        getprofitamDB.UpdateQuantityByPriceIdInDB(bean.getStrPriceId(), total);
                        int ThiQuantity = 1;
                        String StrNewPtice = "";
                        Cursor MyCurserThis = getprofitamDB.ShowTableCartList();
                        for (MyCurserThis.moveToFirst(); !MyCurserThis.isAfterLast(); MyCurserThis.moveToNext()) {
                        ...
                        CartActivity.tvCartTotalAmount.setText(main.getResources().getString(R.string.Rs) + " " + ThiQuantity * Integer.parseInt(StrNewPtice) + "");
