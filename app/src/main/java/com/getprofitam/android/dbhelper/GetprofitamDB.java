package com.getprofitam.android.dbhelper;
 ...
 */
public class GetprofitamDB extends SQLiteOpenHelper {
    ...
    public GetprofitamDB(Context context, String localDbUserIdName) {
        super(context, localDbUserIdName, null, DB_VERSION);
        con = context;
        DB_DBNAME = localDbUserIdName;
    }

    public GetprofitamDB(Context context) {
    ...
    public void OpenDB() {
        ...
        mLocalDecorntDB = new GetprofitamDB(con, DB_DBNAME);
    }
