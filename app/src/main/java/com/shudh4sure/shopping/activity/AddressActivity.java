...
public class AddressActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            shudh4sureDB = new Shudh4sureDB(AddressActivity.this, FinalLocalDBName);
            shudh4sureDB.OpenDB();
        ...
        @SuppressLint("SimpleDateFormat") SimpleDateFormat dfNew = new SimpleDateFormat("dd-MM-yyyy");
    ...
    private class GetUserInformation extends AsyncTask<Void, Void, Api_Model> {
        ...
        protected Api_Model doInBackground(Void... params) {
            try {
                ...
                return methods.UserInfo("get_info", strUserId, strMobile, strCurrentDay.toLowerCase());
            } catch (Exception E) {
    ...
    private class GetUserInformationChange extends AsyncTask<Void, Void, Api_Model> {
        ...
        protected Api_Model doInBackground(Void... params) {
            try {
                IApiMethods methods = restAdapter.create(IApiMethods.class);
                return methods.UserInfo("get_info", strUserId, newMobile, strCurrentDay.toLowerCase());
            } catch (Exception E) {
                return null;
            }
        }
    ...
    private class GetAvailabaleTimeSlot extends AsyncTask<Void, Void, Api_Model> {
        ...
        protected Api_Model doInBackground(Void... params) {
            try {
                IApiMethods methods = restAdapter.create(IApiMethods.class);
                return methods.getAvailableTimeSlot("get_info", strUserId, strMobile, weekDay, "newday");
            } catch (Exception E) {
    ...
    public class CustomListAdapter extends ArrayAdapter<String> {
        ...
        CustomListAdapter(Activity context, ArrayList<String> listItem) {
        ...
        public View getView(int position, View view, @NonNull ViewGroup parent) {
            ...
            @SuppressLint({"ViewHolder", "InflateParams"}) View rowView = inflater.inflate(R.layout.row_timeslots, null, true);
