                ...
                if (curators.msgcode.equals("0")) {
                    ...
                    try {
                        for (Api_Model.add_money_data dataset : curators.add_money_data) {
                            ...
                            mPaymentParams.setSurl("http://www.viragtraders.com/sabzi18/sabzi/index.php?view=walletpayu_result");
                            mPaymentParams.setFurl("http://www.viragtraders.com/sabzi18/sabzi/index.php?view=walletpayu_result");
        ...
        if (requestCode == 1001) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (data.getStringExtra("status").equals("userCancelled")) {
                    Utils.displayDialog(getString(R.string.app_name), WalletActivity.this, false);
