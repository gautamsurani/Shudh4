...
public class Shudh4sureFeedActivity extends AppCompatActivity {
    ...
    WebView webview;
    String url = "http://www.viragtraders.com/sabzi18/facebook/page.php";
    @Override
        ...
        btnRetryinternet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (global.isNetworkAvailable()) {
                    dialog.dismiss();
                    progressDialog = ProgressDialog.show(Shudh4sureFeedActivity.this, "", getResources().getString(R.string.string_plzwait), false, false);
