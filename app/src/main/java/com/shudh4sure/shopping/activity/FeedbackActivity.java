...
public class FeedbackActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initToolbar() {
        ...
        toolbartitle.setText(getResources().getString(R.string.toolbar_feedback));
    ...
    public void onClick(View v) {
        ...
        if (TextUtils.isEmpty(StredtName)) {
            ...
            Utils.ShowSnakBar("Enter Name", relativeMain, FeedbackActivity.this);
        } else if (TextUtils.isEmpty(StredtEmail)) {
            Utils.ShowSnakBar("Enter Email", relativeMain, FeedbackActivity.this);
        } else if (!Utils.isValidEmail(StredtEmail)) {
            Utils.ShowSnakBar("Invalid Email", relativeMain, FeedbackActivity.this);
        } else if (TextUtils.isEmpty(StredtPhone)) {
            Utils.ShowSnakBar("Enter Phone", relativeMain, FeedbackActivity.this);
        } else if (StredtPhone.length() != 10) {
            Utils.ShowSnakBar("Invalid Phone", relativeMain, FeedbackActivity.this);
        } else if (TextUtils.isEmpty(StredtMsg)) {
            Utils.ShowSnakBar("Enter Message", relativeMain, FeedbackActivity.this);
        } else {
            if (global.isNetworkAvailable()) {
                Utils.hideKeyboard(FeedbackActivity.this);
                loading = ProgressDialog.show(FeedbackActivity.this, "", "Please wait...", false, false);
                FeedbackAsync task = new FeedbackAsync();
                task.execute();
            } else {
                retryInternet();
            }
    ...
    private class FeedbackAsync extends AsyncTask<Void, Void, Api_Model> {
        ...
        protected Api_Model doInBackground(Void... params) {
            try {
                ...
                Api_Model curators = methods.FeedbackUsers("feedback", strUserId, StredtName, StredtEmail, StredtPhone, StredtMsg);
        ...
        protected void onPostExecute(Api_Model curators) {
            ...
            if (curators == null) {
                ...
                if (curators.msgcode.equals("0")) {
                    ...
                    Utils.ShowSnakBar(curators.message, relativeMain, FeedbackActivity.this);
                }
            }
        }
    }
        ...
        btnRetryinternet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (global.isNetworkAvailable()) {
                    ...
                    Utils.ShowSnakBar("No internet availbale", relativeMain, FeedbackActivity.this);
