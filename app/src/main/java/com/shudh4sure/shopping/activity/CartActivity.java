...
import com.shudh4sure.shopping.adapter.CartAdapter;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            shudh4sureDB = new Shudh4sureDB(CartActivity.this, FinalLocalDBName);
            shudh4sureDB.OpenDB();
...
*/
                            ...
                            shudh4sureDB.DeleteCartListByPriceID(mWishListData.getStrPriceId());
                    ...
                    if (mWishListData.getCountThis() == 1) {
                        ...
                        for (MyCurserThis.moveToFirst(); !MyCurserThis.isAfterLast(); MyCurserThis.moveToNext()) {
                            TotalCountsdwe = TotalCountsdwe + (MyCurserThis.getInt(7) * Double.parseDouble(MyCurserThis.getString(5)));
                        }
                    ...
                    mWishListData.countThis++;
                    double TotalCountxsx = 0;
                    Cursor MyCurserThis = shudh4sureDB.ShowTableCartList();
                    for (MyCurserThis.moveToFirst(); !MyCurserThis.isAfterLast(); MyCurserThis.moveToNext()) {
                        TotalCountxsx = TotalCountxsx + (MyCurserThis.getInt(7) * Double.parseDouble(MyCurserThis.getString(5)));
                    }
