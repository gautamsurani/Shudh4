...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    TextView txtUserNameHeader, txtUserMobileHeader;
    public TextView tvmytotalitems;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ...
                shudh4sureDB = new Shudh4sureDB(MainActivity.this, FinalLocalDBName);
                shudh4sureDB.OpenDB();
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        lvSabzilanafeed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                drawer.closeDrawer(Gravity.LEFT);
                Intent intent = new Intent(MainActivity.this, Shudh4sureFeedActivity.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        });
