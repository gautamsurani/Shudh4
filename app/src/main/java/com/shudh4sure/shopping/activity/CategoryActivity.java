...
import com.shudh4sure.shopping.adapter.SubCategoryAdapter;
import com.shudh4sure.shopping.dbhelper.Shudh4sureDB;
import com.shudh4sure.shopping.model.SubCategoryModel;
...
public class CategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        shudh4sureDB = new Shudh4sureDB(CategoryActivity.this, FinalLocalDBName);
        shudh4sureDB.OpenDB();
    ...
    private class loadMainCateogry extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String strloadSubCategory = "http://www.viragtraders.com/sabzi18/sabzi/index.php?view=category&userID=1";
